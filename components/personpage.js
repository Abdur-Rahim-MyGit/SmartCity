...
// filepath: c:\Users\abdul jaleel\Videos\TransportApp\components\HomeScreen.js
        ...
        <View style={styles.container}>
            <View style={styles.topview}>
                <View style={styles.welcomecontainer}>
                    <Text style={styles.welcomemessage}>{"Welcome,<br/>Smart City".split("<br/>").join("\n")}</Text>
            ...
            <View style={styles.bottomview}>
                ...
                <View style={{ position: "absolute", bottom: 0, width: "100%" }}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between", margin: 26, backgroundColor: "#fff" }}>
                        ...
                        <Ionicons name="person" size={25} color="#BDBEC1" onPress={() => nav.navigate("person")} />
